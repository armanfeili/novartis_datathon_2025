...
- [x] **Add seasonal pattern detection** from pre-entry months ✅
  - [x] Implemented `_add_seasonal_features()` function with: ✅
    - [x] `seasonal_amplitude`: Max deviation from mean by month-of-year ✅
    - [x] `seasonal_peak_month`: Month with highest volume ✅
    - [x] `seasonal_trough_month`: Month with lowest volume ✅
    - [x] `seasonal_ratio`: Peak-to-trough ratio ✅
    - [x] `seasonal_q1_effect`, `seasonal_q2_effect`, `seasonal_q3_effect`, `seasonal_q4_effect`: Quarter-wise deviations ✅
  - [x] Documented in `configs/features.yaml` ✅
...
- [x] **Add expected_future_generics** - Future n_gxs is EXOGENOUS (provided in test data) ✅
  - [x] Implemented `_add_future_generics_features()` function with: ✅
    - [x] `n_gxs_at_month_12`: Expected n_gxs at month 12 ✅
    - [x] `n_gxs_at_month_23`: Expected n_gxs at end of forecast horizon ✅
    - [x] `n_gxs_change_to_12`, `n_gxs_change_to_23`: Change features ✅
    - [x] `n_gxs_max_forecast`: Maximum n_gxs over forecast horizon ✅
    - [x] `expected_new_generics`: Number of new generics expected ✅
  - [x] NOTE: This is NOT leakage - n_gxs is exogenous (from competitive intelligence) ✅
...
- [x] **Add ther_area_erosion_prior** - Historical avg erosion by area ✅
  - [x] Implemented `add_target_encoding_features()` with K-fold cross-validation ✅
  - [x] CRITICAL: Uses K-fold to compute encoding only from OTHER series (no leakage) ✅
  - [x] Smoothing parameter for regularization ✅
- [x] **Add country_effect** - Country-level erosion patterns ✅
  - [x] `country_erosion_prior` via same target encoding framework ✅
- [x] **Add ther_area encoding** (target encoding with K-fold) ✅
  - [x] Configurable via `configs/features.yaml` `target_encoding` section ✅
...
- [x] **Add ther_area × erosion_pattern** - Area-specific curves ✅
  - [x] `ther_area_x_early_erosion`: Interaction with early erosion (S2 only) ✅
  - [x] `ther_area_erosion_x_time`: Interaction with time ✅
  - [x] Created automatically when target_encoding is enabled ✅

### 3.8 Feature Selection
- [x] **Analyze feature correlations** and remove redundant features ✅
  - [x] `analyze_feature_correlations()` function ✅
  - [x] `remove_redundant_features()` function ✅
- [x] **Use permutation importance** post-training ✅
  - [x] `compute_feature_importance_permutation()` function ✅
  - [x] `select_features_by_importance()` helper ✅
- [x] **Implement feature summary** for analysis ✅
  - [x] `get_feature_summary()` function ✅
...
- [x] **`src/features.py`**:
  ...
  - [x] Added `_add_seasonal_features()` for seasonal pattern detection (Section 3.1) ✅
  ...
  - [x] Added `_add_future_generics_features()` for exogenous future n_gxs (Section 3.3) ✅
  - [x] Updated `add_drug_features()` with is_injection, is_oral, interactions ✅
  - [x] Added `add_target_encoding_features()` with K-fold cross-validation (Section 3.4) ✅
  ...
  - [x] Added Feature Selection utilities (Section 3.8): ✅
    - [x] `analyze_feature_correlations()` ✅
    - [x] `compute_feature_importance_permutation()` ✅
    - [x] `select_features_by_importance()` ✅
    - [x] `get_feature_summary()` ✅
    - [x] `remove_redundant_features()` ✅
- [x] **`tests/test_smoke.py`**:
  ...
  - [x] Added Section 3 tests: ✅
    - [x] `TestSeasonalFeatures`: test_seasonal_features_created, test_seasonal_amplitude_captures_pattern ✅
    - [x] `TestFutureGenericsFeatures`: test_future_generics_features_created, test_future_generics_values_correct ✅
    - [x] `TestTargetEncodingFeatures`: test_target_encoding_function_exists, test_target_encoding_creates_features ✅
    - [x] `TestFeatureSelection`: test_correlation_analysis_*, test_feature_importance_*, test_feature_summary_function, test_remove_redundant_features ✅
    - [x] `TestInteractionFeatures`: test_ther_area_erosion_interaction_created ✅
  - [x] **Test results: 104 passed, 0 skipped, 0 warnings** ✅
